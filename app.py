...
with st.form("form"):
    ...
    person_age = st.number_input("Age", min_value=18, max_value=90, value=30,
                                 help="Enter your age (between 18-90)")
    ...
    person_home_ownership = st.selectbox("Home Ownership", ["Rent", "Own", "Mortgage"],
                                         help="Select your current home ownership status")

    st.header("Loan Information")
    loan_amnt = st.number_input("Loan Amount", value=10000,
                                help="Enter your amount of the loan requested")
    ...
    credit_score = st.number_input("Credit Score", value=700,
                                   help="Enter the applicant's credit score (e.g., between 300 and 850)")
    previous_loan_defaults_on_file = st.selectbox("Previous Loan Defaults", ["Y", "N"],
                                                  help="Have you previously defaulted on a loan? (Y = Yes, N = No)")
